...
const technologies = [
  ...
  },
  {
    name: "Flutter",
    icon: flutter,
    description: "Flutter-Nivel-Intermedio"
  },
  {
    name: "AWS",
    icon: aws,
    description: "AWS-Nivel-Básico"
  },
];
...
const projects = [
  {
    name: "Top Spin Arena",
    description:
      "Plataforma full-stack de alto rendimiento para la gestión de torneos de tenis de mesa en tiempo real. Automatiza la fase de grupos, brackets de eliminación directa, cola FIFO de mesas físicas, control de roles e invitaciones QR.",
    tags: [
      {
        name: "nextjs",
    ...
    image: topspinarena,
    source_code_link: "https://github.com/franabarca/torneostenisdemesa",
    live_link: "https://topspinarena.com",
  },
  {
    name: "Viwith",
    description:
      "Landing page y lista de espera interactiva diseñada para mitigar el burnout docente mediante IA. Cuenta con formulario multi-paso, validación anti-spam con Google ReCAPTCHA, base de datos en tiempo real y seguridad robusta con RLS en Supabase.",
    tags: [
      {
        name: "react",
        color: "blue-text-gradient",
    ...
    image: viwith,
    source_code_link: "",
    live_link: "https://viwith.com",
  },
  {
    name: "TopSpin Payments",
    description:
      "Aplicación móvil nativa para la gestión de membresías, control de caja y emisión automática de comprobantes de pago vía WhatsApp para clubes deportivos.",
    tags: [
      {
        name: "flutter",
        color: "blue-text-gradient",
    ...
    image: topspinpayments,
    source_code_link: "https://github.com/franabarca/topspin_payments",
    live_link: "",
  },
];
